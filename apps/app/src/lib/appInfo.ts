...
| Feature | Description |
| --- | --- |
| Workspace browser | Open as many local folders as you like, each with its own tree, collapsible from its own row, and its own close button. They reopen next time you start. Cloud accounts follow in a later release. |
