...
| Find | Ctrl+F, or Edit > Find. Find marks every match in the open document and steps through them; Find in Files searches the selected folder and everything below it, opening each hit in a tab. Plain text or a regular expression. |
