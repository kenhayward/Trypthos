...
| Images | PNG, JPEG, GIF, WebP, BMP, AVIF and ICO open in a tab, shown at their own size. Nothing to edit and nothing written back, and never sent to a chat model. |
