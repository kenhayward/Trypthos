...
| Zoom and pan | Hold Shift and turn the wheel to zoom, Shift and drag to move around. Text grows in size - the document, its line numbers and its headings together, still wrapped to the panel; a picture is scaled for real, so there is something to pan. Each document keeps its own level, across all three views. |
