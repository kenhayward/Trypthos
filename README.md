...
| Images | PNG, JPEG, GIF, WebP, BMP, AVIF and ICO open in a tab and are shown at their own size. A picture, not a document: nothing to edit, nothing written back, and never sent to a chat model. |
