...
| Markdown editor | Live, Source and Preview views over one document, opening in the view you choose. A mode is a view, never a transform. Pictures the document embeds are drawn in Preview, read from your folder rather than fetched from the web - so one in a private repository appears too. |
